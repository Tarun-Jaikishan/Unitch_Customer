    ...
    return (
      <div className="row">
        <div className="col col-login mx-auto">
          {this.state.msg && (
            <Alert variant={this.state.msg_type}>{this.state.msg}</Alert>
          )}
            ...
            <div className="card-body p-6">
              ...
              <div className="form-group">
                ...
                <input
                  ...
                  value={this.state.form.customer_id.value}
                />
                {!this.state.form.customer_id.is_valid && (
                  <FormErrorDisplay error={this.state.form.customer_id.error} />
                )}
              </div>
              <div className="form-group">
                ...
                <input
                  ...
                  id="box_no"
                  onChange={this.handleChanges}
                  value={this.state.form.box_no.value}
                />
                {!this.state.form.box_no.is_valid && (
                  <FormErrorDisplay error={this.state.form.box_no.error} />
                )}
              </div>
              <div className="form-group">
                ...
                <div className="row">
                  <div className="col-md-3 col-lg-6 col-xs-3">
                    <input
                      ...
                      id="otp"
                      onChange={this.handleChanges}
                      value={this.state.form.otp.value}
                    />
                  </div>
                  <div className="col-md-3 col-lg-6 col-xs-3">
                    <button className="btn btn-purple" onClick={this.sendOtp}>
                      {this.state.otp_text}
                    </button>
                  </div>
                </div>
                {!this.state.form.otp.is_valid && (
                  <FormErrorDisplay error={this.state.form.otp.error} />
                )}
              </div>
              <div className="form-group">
                ...
                />
                {!this.state.form.password.is_valid && (
                  <FormErrorDisplay error={this.state.form.password.error} />
                )}
              </div>
              <div className="form-group">
                ...
                />
                {!this.state.form.confirm_password.is_valid && (
                  <FormErrorDisplay
                    error={this.state.form.confirm_password.error}
                  />
                )}
              </div>
