                    ...
                    <form className="card">
                        <div className="card-body p-6">
                            ...
                            <div className="form-group">
                                ...
                                <input className="form-control" name="username" type="text" id="username" placeholder="Enter username" value={this.state.form.username.value} onChange={this.handleChange} />
                            </div>
                            <div className="form-group">
                                <label className="form-label">Password</label>
                                <input className="form-control" name="password" type="password" id="password" placeholder="Password" value={this.state.form.password.value} onChange={this.handleChange} />
                            </div>
...
const mapDispatchToProps = dispatch => {
    return {
        auth: (username, password, isUserSignin) => dispatch(action.auth(username, password, isUserSignin))
    }
}
