...
const PriceList = ({ handleOnChange, id, ncf_mrp_price, ncf_mrp_tax, ncf_mrp_total, mrp_amount, mrp_price, mrp_tax, mrp_total, name, ncf_sd_channel_count, ncf_sd_channels, nonncf_channel_count }) => (
    <div className="col col-sm-12 col-lg-6" key={id}>
        <div className="card p-3">
            <div className="d-flex align-items-center">
                ...
                <div>
                    ...
                    <small className="sm text-muted" key="ncf_sd_channel_count">NCF Channels : {ncf_sd_channel_count}</small><br />
                    <small className="sm text-muted" key="ncf_mrp_total">NCF Price : {ncf_mrp_total}</small><br />
                    <small className="sm text-muted" key="mrp_total">MRP Price : {mrp_total}</small>
                </div>
            </div>
        </div>
    </div>
