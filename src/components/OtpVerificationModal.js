...
class OtpVerificationModal extends Component {
    ...
    if (token) {
      ...
      return api
        ...
        .catch((error) => {
          ...
          console.log(
            "Error messages",
            error.response.data.data.message.message
          );
        });
    }
  };
  ...
  render() {
    const alertAndLogout = (
      <Modal show={this.state.modal_show} backdrop="static" keyboard={false}>
        <Modal.Body>
        ...
        <Modal show={this.props.modalshow} onHide={this.handleClose}>
          <Form onSubmit={this.handleSubmit}>
            ...
            <Modal.Body className="show-grid">
              <Container>
                {this.state.message && (
                  <Alert key="error_alert" variant="danger">
                    {this.state.message}
                  </Alert>
                )}
                <Row>
                    ...
                    <Col xs={12} md={8}>
                      <Form.Group controlId="email_id">
                        ...
                        <Form.Control
                          ...
                          value={this.state.form.email_otp.value}
                    ...
                    <Col xs={12} md={8}>
                      <Form.Group controlId="mobile_id">
                        ...
                        <Form.Control
                          ...
                          value={this.state.form.mobile_otp.value}
                          onChange={this.handleChange}
                        />
...
export default connect(
  null,
  mapDispatchToProps
)(withRouter(OtpVerificationModal));
